...
// Espelho do contrato servido pelo agente em /metrics.
//
// Vive aqui, e nao no agente, porque cliente e agente ainda sao modulos
// separados enquanto a migracao acontece. Um teste compara este arquivo com
// o do agente campo a campo: divergencia silenciosa entre os dois lados
// seria um campo que o cliente le como zero para sempre.
package metricas
...
// nao faz parte do fio
type _AmostraNet struct {
	RX, RXPkt, RXErr int64
	TX, TXPkt, TXErr int64
}

// nao faz parte do fio
type _AmostraIO struct {
